...
%plot(1:length(J_history), J1, 'b');


%plot(1:length(J_history), J2, 'r');
%plot(1:length(J_history), J3, 'k');
...
new_tuple = ([1650 3] - mu) ./ sigma
theta
 [ 1 new_tuple ] 
price = [ 1 new_tuple ] * theta; % You should change this
price
